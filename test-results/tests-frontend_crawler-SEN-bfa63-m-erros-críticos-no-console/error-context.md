...
- Name: tests\frontend_crawler.spec.ts >> SENTINELA | Frontend Crawler & Button Tester >> Deve renderizar a rota /alvos sem erros críticos no console
...
Expected length: 0
Received length: 3
Received array:  ["Failed to load resource: the server responded with a status of 404 (Not Found)", "Failed to load resource: the server responded with a status of 400 ()", "Failed to load resource: the server responded with a status of 404 (Not Found)"]
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e45]:
      - generic [ref=e47]:
        - generic [ref=e48]:
          - heading "Central de Candidatos" [level=1] [ref=e49]
          - paragraph [ref=e50]: Gerenciamento e radar de alvos ativos no monitoramento. Acompanhe o score de risco e a volumetria de cada perfil sob observação cívica.
        - generic [ref=e51]:
          - generic [ref=e52]:
            - generic [ref=e53]:
              - generic [ref=e54]:
                - heading "Candidatos Monitorados" [level=2] [ref=e55]:
                  - img [ref=e56]
                  - text: Candidatos Monitorados
                - paragraph [ref=e61]: Radar de Severidade e Atividade
              - button "Filtrar" [ref=e62]:
                - img [ref=e63]
                - text: Filtrar
            - generic [ref=e66]: SINCRONIZANDO COM O OBSERVATÓRIO...
            - generic [ref=e67]: Exibindo 0 de 0 perfis monitorados.
          - insertion [ref=e69]:
            - iframe [ref=e71]:
