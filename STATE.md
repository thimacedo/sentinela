...
| Coleta Independente (IGWorkerV2) | Operacional | Motor V2 v83.6: Proteção contra conexões fechadas de navegador, timeout de cliques de modais (10s), e controle inteligente de loop de posts |
