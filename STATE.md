...
- Elevado o nível de log de sucesso da classificação de IA individual para INFO no core/ai_service.py para dar transparência ao operador sobre qual IA da cascata realizou o trabalho (Fase 4 - executado por gemini-2.5-pro-preview).
