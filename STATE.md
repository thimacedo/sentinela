...
- Elevado o nível de log de sucesso da classificação de IA individual para INFO no core/ai_service.py, incluindo o texto do comentário formatado e truncado a 60 caracteres no log do terminal para auditoria direta (Fase 4 - executado por gemini-2.5-pro-preview).
