...
- **Correção de Menu Travado (Win32)**: Substituímos os callbacks de títulos dinâmicos por strings estáticas reconstruídas dinamicamente a cada 5 segundos ou imediatamente após cliques. Isso elimina o bug do Windows/pystray que deixava o menu travado em branco até que o mouse passasse por cima.
