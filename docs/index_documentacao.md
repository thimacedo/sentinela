...
*   **[`docs/ARCHITECTURE_PASA_V86.md`](ARCHITECTURE_PASA_V86.md)**: A Visão Geral da Governança de Inteligência. Descreve a interação entre Stealth Scraping, Ollama Triage, Network Clusters e o Worker Tesoureiro. (v86.0)
*   **[`docs/database_schema_v58.md`](database_schema_v58.md)**: O mapa de dados. Contém o modelo relacional (Mermaid), tabelas, colunas (com tipos) e os relacionamentos do banco PostgreSQL/Supabase.
*   **[`docs/project_functions_v58.md`](project_functions_v58.md)**: O mapeamento lógico. Detalha o funcionamento do Orquestrador, Motor de Coleta V2 (Playwright), Serviço de IA (MCA v2.2) e do Supervisor de Saúde (Watchdog).
